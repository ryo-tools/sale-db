import { type Gettable } from '@atproto/xrpc';
import { Agent } from './agent.js';
import { type ComAtprotoServerCreateAccount, type ComAtprotoServerCreateSession, type ComAtprotoServerGetSession, ComAtprotoServerNS, type ComAtprotoServerRefreshSession } from './client/index.js';
import type { SessionManager } from './session-manager.js';
import type { AtpAgentLoginOpts, AtpPersistSessionHandler, AtpSessionData } from './types.js';
...
export declare class CredentialSession implements SessionManager {
    ...
    refreshSessionPromise?: Promise<ComAtprotoServerRefreshSession.Response>;
    /**
     ...
     * session was set.
     */
    resumeSession(session: AtpSessionData): Promise<ComAtprotoServerRefreshSession.Response>;
    /**
     * Internal helper to refresh sessions
     * - Wraps the actual implementation in a promise-guard to ensure only
     *   one refresh is attempted at a time.
     */
    refreshSession(): Promise<ComAtprotoServerRefreshSession.Response>;
    /**
