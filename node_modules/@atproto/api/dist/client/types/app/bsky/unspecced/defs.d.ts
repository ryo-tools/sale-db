...
export declare function isSkeletonSearchPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "skeletonSearchPost">;
...
export declare function isSkeletonSearchActor<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "skeletonSearchActor">;
...
export declare function isSkeletonSearchStarterPack<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "skeletonSearchStarterPack">;
...
export declare function isTrendingTopic<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "trendingTopic">;
...
export declare function isSkeletonTrend<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "skeletonTrend">;
...
export declare function isTrendView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "trendView">;
...
export declare function isThreadItemPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "threadItemPost">;
...
export declare function isThreadItemNoUnauthenticated<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "threadItemNoUnauthenticated">;
...
export declare function isThreadItemNotFound<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "threadItemNotFound">;
...
export declare function isThreadItemBlocked<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "threadItemBlocked">;
...
export declare function isAgeAssuranceState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "ageAssuranceState">;
...
export declare function isAgeAssuranceEvent<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.unspecced.defs", "ageAssuranceEvent">;
