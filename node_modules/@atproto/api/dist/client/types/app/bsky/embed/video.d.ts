...
export declare function isMain<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.video", "main">;
...
export declare function isCaption<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.video", "caption">;
...
export declare function isView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.embed.video", "view">;
