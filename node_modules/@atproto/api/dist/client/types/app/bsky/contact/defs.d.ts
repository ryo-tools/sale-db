...
export declare function isMatchAndContactIndex<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.contact.defs", "matchAndContactIndex">;
...
export declare function isSyncStatus<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.contact.defs", "syncStatus">;
...
export declare function isNotification<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.contact.defs", "notification">;
