...
export declare function isBookmark<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.bookmark.defs", "bookmark">;
...
export declare function isBookmarkView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.bookmark.defs", "bookmarkView">;
