...
export declare function isState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "state">;
...
export declare function isStateMetadata<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "stateMetadata">;
...
export declare function isConfig<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "config">;
...
export declare function isConfigRegion<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegion">;
...
export declare function isConfigRegionRuleDefault<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleDefault">;
...
export declare function isConfigRegionRuleIfDeclaredOverAge<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleIfDeclaredOverAge">;
...
export declare function isConfigRegionRuleIfDeclaredUnderAge<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleIfDeclaredUnderAge">;
...
export declare function isConfigRegionRuleIfAssuredOverAge<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleIfAssuredOverAge">;
...
export declare function isConfigRegionRuleIfAssuredUnderAge<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleIfAssuredUnderAge">;
...
export declare function isConfigRegionRuleIfAccountNewerThan<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleIfAccountNewerThan">;
...
export declare function isConfigRegionRuleIfAccountOlderThan<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "configRegionRuleIfAccountOlderThan">;
...
export declare function isEvent<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.ageassurance.defs", "event">;
