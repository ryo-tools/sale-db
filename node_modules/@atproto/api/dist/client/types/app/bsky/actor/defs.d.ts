...
export declare function isProfileViewBasic<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileViewBasic">;
...
export declare function isProfileView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileView">;
...
export declare function isProfileViewDetailed<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileViewDetailed">;
...
export declare function isProfileAssociated<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileAssociated">;
...
export declare function isProfileAssociatedChat<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileAssociatedChat">;
...
export declare function isProfileAssociatedGerm<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileAssociatedGerm">;
...
export declare function isProfileAssociatedActivitySubscription<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "profileAssociatedActivitySubscription">;
...
export declare function isViewerState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "viewerState">;
...
export declare function isKnownFollowers<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "knownFollowers">;
...
export declare function isVerificationState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "verificationState">;
...
export declare function isVerificationView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "verificationView">;
...
export declare function isAdultContentPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "adultContentPref">;
...
export declare function isContentLabelPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "contentLabelPref">;
...
export declare function isSavedFeed<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "savedFeed">;
export declare function validateSavedFeed<V>(v: V): ValidationResult<SavedFeed & V>;
export interface SavedFeedsPrefV2 {
    $type?: 'app.bsky.actor.defs#savedFeedsPrefV2';
    items: SavedFeed[];
}
export declare function isSavedFeedsPrefV2<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "savedFeedsPrefV2">;
...
export declare function isSavedFeedsPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "savedFeedsPref">;
...
export declare function isPersonalDetailsPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "personalDetailsPref">;
...
export declare function isDeclaredAgePref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "declaredAgePref">;
...
export declare function isFeedViewPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "feedViewPref">;
...
export declare function isThreadViewPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "threadViewPref">;
...
export declare function isInterestsPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "interestsPref">;
...
export declare function isMutedWord<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "mutedWord">;
...
export declare function isMutedWordsPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "mutedWordsPref">;
...
export declare function isHiddenPostsPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "hiddenPostsPref">;
...
export declare function isLabelersPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "labelersPref">;
...
export declare function isLabelerPrefItem<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "labelerPrefItem">;
...
export declare function isBskyAppStatePref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "bskyAppStatePref">;
...
export declare function isBskyAppProgressGuide<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "bskyAppProgressGuide">;
...
export declare function isNux<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "nux">;
...
export declare function isVerificationPrefs<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "verificationPrefs">;
...
export declare function isLiveEventPreferences<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "liveEventPreferences">;
...
export declare function isPostInteractionSettingsPref<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "postInteractionSettingsPref">;
...
export declare function isStatusView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.actor.defs", "statusView">;
