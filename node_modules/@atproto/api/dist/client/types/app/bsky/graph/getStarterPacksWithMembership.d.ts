...
export declare function isStarterPackWithMembership<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.graph.getStarterPacksWithMembership", "starterPackWithMembership">;
