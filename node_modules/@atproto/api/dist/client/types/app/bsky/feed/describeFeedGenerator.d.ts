...
export declare function isFeed<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.describeFeedGenerator", "feed">;
...
export declare function isLinks<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.feed.describeFeedGenerator", "links">;
