...
export declare function isRecordDeleted<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "recordDeleted">;
...
export declare function isChatPreference<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "chatPreference">;
...
export declare function isFilterablePreference<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "filterablePreference">;
...
export declare function isPreference<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "preference">;
...
export declare function isPreferences<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "preferences">;
...
export declare function isActivitySubscription<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "activitySubscription">;
...
export declare function isSubjectActivitySubscription<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.notification.defs", "subjectActivitySubscription">;
