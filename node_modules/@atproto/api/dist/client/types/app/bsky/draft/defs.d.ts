...
export declare function isDraftWithId<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftWithId">;
...
export declare function isDraft<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draft">;
...
export declare function isDraftPost<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftPost">;
...
export declare function isDraftView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftView">;
...
export declare function isDraftEmbedLocalRef<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedLocalRef">;
...
export declare function isDraftEmbedCaption<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedCaption">;
export declare function validateDraftEmbedCaption<V>(v: V): ValidationResult<DraftEmbedCaption & V>;
export interface DraftEmbedGallery {
    $type?: 'app.bsky.draft.defs#draftEmbedGallery';
    items: DraftEmbedGalleryItems;
}
export declare function isDraftEmbedGallery<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedGallery">;
export declare function validateDraftEmbedGallery<V>(v: V): ValidationResult<DraftEmbedGallery & V>;
export type DraftEmbedGalleryItems = ($Typed<DraftEmbedImage> | {
    $type: string;
})[];
...
export declare function isDraftEmbedImage<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedImage">;
...
export declare function isDraftEmbedVideo<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedVideo">;
...
export declare function isDraftEmbedExternal<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedExternal">;
...
export declare function isDraftEmbedRecord<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.draft.defs", "draftEmbedRecord">;
