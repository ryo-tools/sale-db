...
export declare function isLabelerView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.labeler.defs", "labelerView">;
...
export declare function isLabelerViewDetailed<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.labeler.defs", "labelerViewDetailed">;
...
export declare function isLabelerViewerState<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.labeler.defs", "labelerViewerState">;
...
export declare function isLabelerPolicies<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "app.bsky.labeler.defs", "labelerPolicies">;
