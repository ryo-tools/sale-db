...
export declare function isLinks<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.server.describeServer", "links">;
export declare function validateLinks<V>(v: V): ValidationResult<Links & V>;
export interface Contact {
    $type?: 'com.atproto.server.describeServer#contact';
    email?: string;
}
export declare function isContact<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.server.describeServer", "contact">;
