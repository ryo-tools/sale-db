...
export declare function isResultAvailable<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.temp.checkHandleAvailability", "resultAvailable">;
...
export declare function isResultUnavailable<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.temp.checkHandleAvailability", "resultUnavailable">;
...
export declare function isSuggestion<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.temp.checkHandleAvailability", "suggestion">;
