...
export declare function isCreate<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.repo.applyWrites", "create">;
...
export declare function isUpdate<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.repo.applyWrites", "update">;
...
export declare function isDelete<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.repo.applyWrites", "delete">;
...
export declare function isCreateResult<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.repo.applyWrites", "createResult">;
...
export declare function isUpdateResult<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.repo.applyWrites", "updateResult">;
export declare function validateUpdateResult<V>(v: V): ValidationResult<UpdateResult & V>;
export interface DeleteResult {
    $type?: 'com.atproto.repo.applyWrites#deleteResult';
}
export declare function isDeleteResult<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "com.atproto.repo.applyWrites", "deleteResult">;
