...
export declare function isMain<V>(v: V): v is import("../../../util.js").$TypedObject<V, "com.germnetwork.declaration", "main">;
...
export declare function isMessageMe<V>(v: V): v is import("../../../util.js").$TypedObject<V, "com.germnetwork.declaration", "messageMe">;
