...
export declare function isServiceConfig<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.server.getConfig", "serviceConfig">;
...
export declare function isViewerConfig<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.server.getConfig", "viewerConfig">;
