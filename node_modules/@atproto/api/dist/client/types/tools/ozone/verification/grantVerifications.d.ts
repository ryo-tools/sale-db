...
export declare function isVerificationInput<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.verification.grantVerifications", "verificationInput">;
...
export declare function isGrantError<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.verification.grantVerifications", "grantError">;
