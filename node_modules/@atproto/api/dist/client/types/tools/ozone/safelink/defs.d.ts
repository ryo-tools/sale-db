...
export declare function isEvent<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.safelink.defs", "event">;
...
export declare function isUrlRule<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.safelink.defs", "urlRule">;
