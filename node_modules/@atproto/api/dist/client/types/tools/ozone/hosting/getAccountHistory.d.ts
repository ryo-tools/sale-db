...
export declare function isEvent<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.hosting.getAccountHistory", "event">;
...
export declare function isAccountCreated<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.hosting.getAccountHistory", "accountCreated">;
...
export declare function isEmailUpdated<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.hosting.getAccountHistory", "emailUpdated">;
...
export declare function isEmailConfirmed<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.hosting.getAccountHistory", "emailConfirmed">;
...
export declare function isPasswordUpdated<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.hosting.getAccountHistory", "passwordUpdated">;
...
export declare function isHandleUpdated<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.hosting.getAccountHistory", "handleUpdated">;
