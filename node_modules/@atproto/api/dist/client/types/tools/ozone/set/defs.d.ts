...
export declare function isSet<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.set.defs", "set">;
...
export declare function isSetView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.set.defs", "setView">;
