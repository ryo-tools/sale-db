...
export declare function isCancellationResults<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.cancelScheduledActions", "cancellationResults">;
...
export declare function isFailedCancellation<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.cancelScheduledActions", "failedCancellation">;
