...
export declare function isTimelineItem<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.getAccountTimeline", "timelineItem">;
...
export declare function isTimelineItemSummary<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.getAccountTimeline", "timelineItemSummary">;
