...
export declare function isTakedown<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.scheduleAction", "takedown">;
...
export declare function isSchedulingConfig<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.scheduleAction", "schedulingConfig">;
...
export declare function isScheduledActionResults<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.scheduleAction", "scheduledActionResults">;
...
export declare function isFailedScheduling<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.moderation.scheduleAction", "failedScheduling">;
