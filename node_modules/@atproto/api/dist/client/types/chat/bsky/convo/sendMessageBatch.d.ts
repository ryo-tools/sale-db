...
export declare class ReplyTargetNotFoundError extends XRPCError {
    constructor(src: XRPCError);
}
...
export declare function isBatchItem<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "chat.bsky.convo.sendMessageBatch", "batchItem">;
