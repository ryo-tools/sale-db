...
export declare class AppBskyEmbedNS {
    _client: XrpcClient;
    constructor(client: XrpcClient);
    getEmbedExternalView(params?: AppBskyEmbedGetEmbedExternalView.QueryParams, opts?: AppBskyEmbedGetEmbedExternalView.CallOptions): Promise<AppBskyEmbedGetEmbedExternalView.Response>;
}
export declare class AppBskyFeedNS {
    ...
    searchPostsV2(params?: AppBskyFeedSearchPostsV2.QueryParams, opts?: AppBskyFeedSearchPostsV2.CallOptions): Promise<AppBskyFeedSearchPostsV2.Response>;
...
export declare class AppBskyGraphNS {
    ...
    searchStarterPacksV2(params?: AppBskyGraphSearchStarterPacksV2.QueryParams, opts?: AppBskyGraphSearchStarterPacksV2.CallOptions): Promise<AppBskyGraphSearchStarterPacksV2.Response>;
...
export declare class ChatBskyActorNS {
    ...
    getStatus(params?: ChatBskyActorGetStatus.QueryParams, opts?: ChatBskyActorGetStatus.CallOptions): Promise<ChatBskyActorGetStatus.Response>;
}
...
export declare class ChatBskyConvoNS {
    ...
    getUnreadCounts(params?: ChatBskyConvoGetUnreadCounts.QueryParams, opts?: ChatBskyConvoGetUnreadCounts.CallOptions): Promise<ChatBskyConvoGetUnreadCounts.Response>;
...
export declare class ChatBskyGroupNS {
    ...
    getJoinLinkPreviews(params?: ChatBskyGroupGetJoinLinkPreviews.QueryParams, opts?: ChatBskyGroupGetJoinLinkPreviews.CallOptions): Promise<ChatBskyGroupGetJoinLinkPreviews.Response>;
    ...
    listMutualGroups(params?: ChatBskyGroupListMutualGroups.QueryParams, opts?: ChatBskyGroupListMutualGroups.CallOptions): Promise<ChatBskyGroupListMutualGroups.Response>;
    ...
    updateJoinRequestsRead(data?: ChatBskyGroupUpdateJoinRequestsRead.InputSchema, opts?: ChatBskyGroupUpdateJoinRequestsRead.CallOptions): Promise<ChatBskyGroupUpdateJoinRequestsRead.Response>;
    withdrawJoinRequest(data?: ChatBskyGroupWithdrawJoinRequest.InputSchema, opts?: ChatBskyGroupWithdrawJoinRequest.CallOptions): Promise<ChatBskyGroupWithdrawJoinRequest.Response>;
}
export declare class ChatBskyModerationNS {
    ...
    getConvo(params?: ChatBskyModerationGetConvo.QueryParams, opts?: ChatBskyModerationGetConvo.CallOptions): Promise<ChatBskyModerationGetConvo.Response>;
    getConvoMembers(params?: ChatBskyModerationGetConvoMembers.QueryParams, opts?: ChatBskyModerationGetConvoMembers.CallOptions): Promise<ChatBskyModerationGetConvoMembers.Response>;
    getConvos(params?: ChatBskyModerationGetConvos.QueryParams, opts?: ChatBskyModerationGetConvos.CallOptions): Promise<ChatBskyModerationGetConvos.Response>;
...
export declare class ChatBskyNotificationNS {
    _client: XrpcClient;
    constructor(client: XrpcClient);
    getPreferences(params?: ChatBskyNotificationGetPreferences.QueryParams, opts?: ChatBskyNotificationGetPreferences.CallOptions): Promise<ChatBskyNotificationGetPreferences.Response>;
    putPreferences(data?: ChatBskyNotificationPutPreferences.InputSchema, opts?: ChatBskyNotificationPutPreferences.CallOptions): Promise<ChatBskyNotificationPutPreferences.Response>;
}
...
export declare class ToolsOzoneQueueNS {
    _client: XrpcClient;
    constructor(client: XrpcClient);
    assignModerator(data?: ToolsOzoneQueueAssignModerator.InputSchema, opts?: ToolsOzoneQueueAssignModerator.CallOptions): Promise<ToolsOzoneQueueAssignModerator.Response>;
    createQueue(data?: ToolsOzoneQueueCreateQueue.InputSchema, opts?: ToolsOzoneQueueCreateQueue.CallOptions): Promise<ToolsOzoneQueueCreateQueue.Response>;
    deleteQueue(data?: ToolsOzoneQueueDeleteQueue.InputSchema, opts?: ToolsOzoneQueueDeleteQueue.CallOptions): Promise<ToolsOzoneQueueDeleteQueue.Response>;
    getAssignments(params?: ToolsOzoneQueueGetAssignments.QueryParams, opts?: ToolsOzoneQueueGetAssignments.CallOptions): Promise<ToolsOzoneQueueGetAssignments.Response>;
    listQueues(params?: ToolsOzoneQueueListQueues.QueryParams, opts?: ToolsOzoneQueueListQueues.CallOptions): Promise<ToolsOzoneQueueListQueues.Response>;
    routeReports(data?: ToolsOzoneQueueRouteReports.InputSchema, opts?: ToolsOzoneQueueRouteReports.CallOptions): Promise<ToolsOzoneQueueRouteReports.Response>;
    unassignModerator(data?: ToolsOzoneQueueUnassignModerator.InputSchema, opts?: ToolsOzoneQueueUnassignModerator.CallOptions): Promise<ToolsOzoneQueueUnassignModerator.Response>;
    updateQueue(data?: ToolsOzoneQueueUpdateQueue.InputSchema, opts?: ToolsOzoneQueueUpdateQueue.CallOptions): Promise<ToolsOzoneQueueUpdateQueue.Response>;
}
export declare class ToolsOzoneReportNS {
    _client: XrpcClient;
    constructor(client: XrpcClient);
    assignModerator(data?: ToolsOzoneReportAssignModerator.InputSchema, opts?: ToolsOzoneReportAssignModerator.CallOptions): Promise<ToolsOzoneReportAssignModerator.Response>;
    closeReports(data?: ToolsOzoneReportCloseReports.InputSchema, opts?: ToolsOzoneReportCloseReports.CallOptions): Promise<ToolsOzoneReportCloseReports.Response>;
    createActivity(data?: ToolsOzoneReportCreateActivity.InputSchema, opts?: ToolsOzoneReportCreateActivity.CallOptions): Promise<ToolsOzoneReportCreateActivity.Response>;
    getAssignments(params?: ToolsOzoneReportGetAssignments.QueryParams, opts?: ToolsOzoneReportGetAssignments.CallOptions): Promise<ToolsOzoneReportGetAssignments.Response>;
    getHistoricalStats(params?: ToolsOzoneReportGetHistoricalStats.QueryParams, opts?: ToolsOzoneReportGetHistoricalStats.CallOptions): Promise<ToolsOzoneReportGetHistoricalStats.Response>;
    getLatestReport(params?: ToolsOzoneReportGetLatestReport.QueryParams, opts?: ToolsOzoneReportGetLatestReport.CallOptions): Promise<ToolsOzoneReportGetLatestReport.Response>;
    getLiveStats(params?: ToolsOzoneReportGetLiveStats.QueryParams, opts?: ToolsOzoneReportGetLiveStats.CallOptions): Promise<ToolsOzoneReportGetLiveStats.Response>;
    getReport(params?: ToolsOzoneReportGetReport.QueryParams, opts?: ToolsOzoneReportGetReport.CallOptions): Promise<ToolsOzoneReportGetReport.Response>;
    listActivities(params?: ToolsOzoneReportListActivities.QueryParams, opts?: ToolsOzoneReportListActivities.CallOptions): Promise<ToolsOzoneReportListActivities.Response>;
    queryActivities(params?: ToolsOzoneReportQueryActivities.QueryParams, opts?: ToolsOzoneReportQueryActivities.CallOptions): Promise<ToolsOzoneReportQueryActivities.Response>;
    queryReports(params?: ToolsOzoneReportQueryReports.QueryParams, opts?: ToolsOzoneReportQueryReports.CallOptions): Promise<ToolsOzoneReportQueryReports.Response>;
    reassignQueue(data?: ToolsOzoneReportReassignQueue.InputSchema, opts?: ToolsOzoneReportReassignQueue.CallOptions): Promise<ToolsOzoneReportReassignQueue.Response>;
    refreshStats(data?: ToolsOzoneReportRefreshStats.InputSchema, opts?: ToolsOzoneReportRefreshStats.CallOptions): Promise<ToolsOzoneReportRefreshStats.Response>;
    unassignModerator(data?: ToolsOzoneReportUnassignModerator.InputSchema, opts?: ToolsOzoneReportUnassignModerator.CallOptions): Promise<ToolsOzoneReportUnassignModerator.Response>;
}
