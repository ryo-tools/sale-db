import { AppBskyEmbedRecord, AppBskyEmbedRecordWithMedia, ComAtprotoLabelDefs, } from '../client/index.js';
import { asPredicate } from '../client/util.js';
export function isQuotedPost(embed) {
    return Boolean(embed && AppBskyEmbedRecord.isView(embed));
}
export function isQuotedPostWithMedia(embed) {
    return Boolean(embed && AppBskyEmbedRecordWithMedia.isView(embed));
}
export function interpretLabelValueDefinition(def, definedBy) {
    const behaviors = {
        account: {},
        profile: {},
        content: {},
...
export function interpretLabelValueDefinitions(labelerView) {
