...
import { AppBskyActorDefs, AppBskyActorProfile, type AppBskyFeedPost, AppNS, ChatNS, ComNS, ToolsNS } from './client/index.js';
import type { MutedWord, Nux } from './client/types/app/bsky/actor/defs.js';
import type { Un$Typed } from './client/util.js';
import type { InterpretedLabelValueDefinition, LabelPreference, ModerationPrefs } from './moderation/types.js';
import type { SessionManager } from './session-manager.js';
import { type AtpAgentGlobalOpts, type AtprotoProxy, type AtprotoServiceType, type BskyFeedViewPreference, type BskyInterestsPreference, type BskyPreferences, type BskyThreadViewPreference } from './types.js';
...
export declare class Agent extends XrpcClient {
    ...
    proxy?: AtprotoProxy;
    configureProxy(value: AtprotoProxy | null): void;
    ...
    get accountDid(): `did:${string}:${string}`;
    /**
     ...
     */
    upsertProfile(updateFn: (existing: AppBskyActorProfile.Record | undefined) => Un$Typed<AppBskyActorProfile.Record> | Promise<Un$Typed<AppBskyActorProfile.Record>>): Promise<void>;
    mute(actor: string): Promise<import("./client/types/app/bsky/graph/muteActor.js").Response>;
    unmute(actor: string): Promise<import("./client/types/app/bsky/graph/unmuteActor.js").Response>;
    muteModList(uri: string): Promise<import("./client/types/app/bsky/graph/muteActorList.js").Response>;
    unmuteModList(uri: string): Promise<import("./client/types/app/bsky/graph/unmuteActorList.js").Response>;
    blockModList(uri: string): Promise<{
        uri: string;
        cid: string;
    }>;
    unblockModList(uri: string): Promise<void>;
    updateSeenNotifications(seenAt?: string): Promise<import("./client/types/app/bsky/notification/updateSeen.js").Response>;
     ...
     */
    setIsBetaUser(isBetaUser: boolean): Promise<void>;
    /**
    ...
    updateLiveEventPreferences(action: {
        type: 'hideFeed';
        id: string;
    } | {
        type: 'unhideFeed';
