...
// --------
export const isValidDidDoc = (doc) => {
    return didDocument.safeParse(doc).success;
};
export const getDid = (doc) => {
    const id = doc.id;
    if (typeof id !== 'string') {
...
export const getSigningKey = (doc) => {
    return getVerificationMaterial(doc, 'atproto');
};
export const getVerificationMaterial = (doc, keyId) => {
    // /!\ Hot path
...
export const getSigningDidKey = (doc) => {
...
export const getFeedGenEndpoint = (doc) => {
    return getServiceEndpoint(doc, {
        id: '#bsky_fg',
        type: 'BskyFeedGenerator',
    });
};
export const getNotifEndpoint = (doc) => {
    return getServiceEndpoint(doc, {
        id: '#bsky_notif',
        type: 'BskyNotificationService',
    });
};
export const getServiceEndpoint = (doc, opts) => {
    // /!\ Hot path
